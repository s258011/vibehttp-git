...
if(url_param != null)
    var socket = io(url_param);
else
//    var socket = io('https://vibe-ml-project.ew.r.appspot.com');
...
//var socket = io('https://puzzle-vibe-ml-version-3-o5tympfaqq-lz.a.run.app');
//var socket = io('https://35.228.30.201:8080');


//var socket = io('https://nifty-foundry-292614.ew.r.appspot.com');
//var socket = io('http://35.228.68.86:8080');
//var socket = io('https://puzzle-vibe-ml.xyz/');
//var socket = io('https://35.228.202.153/');
var tta = '';
